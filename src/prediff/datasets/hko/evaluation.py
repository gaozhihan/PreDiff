...
class HKOSkillScore(Metric):
    ...
    def __init__(self,
                 ...
                 threshold_list: Sequence[int] = (16, 74, 133, 160, 181, 219),  # adapted default values from SEVIR
        ...
        mode:   str
            ...
            "2":
                ...
                return
                    ...
                    score_avg shape = (1, )
        preprocess_type：    str
            valid values are "none", f"pool{s}", where `s` is the pool scale factor
        threshold_list
        """
        super().__init__()
        self.layout = layout
        self.parse_layout()
        assert preprocess_type == "none" or preprocess_type.startswith("pool")
    ...
    def preprocess(self, pred, target):
        ...
        elif self.preprocess_type.startswith("pool"):
