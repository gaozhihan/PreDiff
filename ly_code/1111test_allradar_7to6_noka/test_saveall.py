...
def get_parser():
    ...
    parser.add_argument('--save', default='1111_allradar_test_7to6_lr1e4_49ckpt', type=str)
    parser.add_argument('--nodes', default=1, type=int,
                        help="Number of nodes in DDP training.")
    parser.add_argument('--gpus', default=1, type=int,
                        help="Number of GPUS per node in DDP training.")
    parser.add_argument('--cfg', default='/data/25fall_nowcasting/ly/PreDiff-25fall/ly_code/1111test_allradar_7to6_noka/prediff_sevirlr_v1_finetune.yaml', type=str)
    parser.add_argument('--test', default=True, action='store_true')
    parser.add_argument('--ckpt_name', default='049.ckpt', type=str,
