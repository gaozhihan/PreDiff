...
def get_parser():
    ...
    parser.add_argument('--save', default='1022_all18sample_train_epoch_10000_val50', type=str)
    parser.add_argument('--nodes', default=1, type=int,
                        help="Number of nodes in DDP training.")
    parser.add_argument('--gpus', default=1, type=int,
                        help="Number of GPUS per node in DDP training.")
    parser.add_argument('--cfg', default='/data/25fall_nowcasting/ly/PreDiff-25fall/ly_code/1014pre1/sevirlr/prediff_sevirlr_v1.yaml', type=str)
