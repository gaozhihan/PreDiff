...
def get_parser():
    ...
    parser.add_argument('--save', default='1111_allradar_train_scratch_ep10000_10to20_val50', type=str)
    parser.add_argument('--nodes', default=1, type=int,
                        help="Number of nodes in DDP training.")
    parser.add_argument('--gpus', default=1, type=int,
                        help="Number of GPUS per node in DDP training.")
    parser.add_argument('--cfg', default='/data/25fall_nowcasting/ly/PreDiff-25fall/ly_code/1111train_allradar_10to20/prediff_sevirlr_v1_finetune.yaml', type=str)
    parser.add_argument('--test', default=False, action='store_true')
    parser.add_argument('--ckpt_name', default='1499.ckpt', type=str,
