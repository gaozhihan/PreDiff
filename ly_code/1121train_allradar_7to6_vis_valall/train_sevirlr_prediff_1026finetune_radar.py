...
def get_parser():
    ...
    parser.add_argument('--save', default='1121_allradar_train_finetune99pt_ep2000_val50', type=str)
    parser.add_argument('--nodes', default=1, type=int,
                        help="Number of nodes in DDP training.")
    parser.add_argument('--gpus', default=2, type=int,
                        help="Number of GPUS per node in DDP training.")
    parser.add_argument('--cfg', default='/home/user01/personal_file/ly/PreDiff-25fall/ly_code/1121train_allradar_7to6_vis_valall/prediff_sevirlr_v1_finetune.yaml', type=str)
