...
def get_parser():
    ...
    parser.add_argument('--save', default='1124_allradar_test_7to6_500ckpt', type=str)
    parser.add_argument('--nodes', default=1, type=int,
                        help="Number of nodes in DDP training.")
    parser.add_argument('--gpus', default=2, type=int,
                        help="Number of GPUS per node in DDP training.")
    parser.add_argument('--cfg', default='/home/user01/personal_file/ly/PreDiff-25fall/ly_code/1124test_allradar_7to6/prediff_sevirlr_v1_finetune.yaml', type=str)
    parser.add_argument('--test', default=True, action='store_true')
    parser.add_argument('--ckpt_name', default='524.ckpt', type=str,
