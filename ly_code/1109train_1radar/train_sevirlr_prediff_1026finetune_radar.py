...
def get_parser():
    ...
    parser.add_argument('--save', default='1109_1radar_train_checkpoints_10to20_aug0_val200', type=str)
    parser.add_argument('--nodes', default=1, type=int,
                        help="Number of nodes in DDP training.")
    parser.add_argument('--gpus', default=1, type=int,
                        help="Number of GPUS per node in DDP training.")
    parser.add_argument('--cfg', default='/data/25fall_nowcasting/ly/PreDiff-25fall/ly_code/1109train_1radar/prediff_sevirlr_v1_finetune.yaml', type=str)
